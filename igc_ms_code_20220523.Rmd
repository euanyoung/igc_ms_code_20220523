...
reproductive_values <- genetic_contributions[genetic_contributions$Parish=="Elm"& genetic_contributions$Cohort<(1990-Elm_st_time)|genetic_contributions$Parish=="Lin"& genetic_contributions$Cohort<(1990-Lin_st_time),]

reproductive_values$Sex <- as.factor(reproductive_values$Sex)
reproductive_values$Parish <- as.factor(reproductive_values$Parish)
...
reproductive_values <- left_join(reproductive_values, fitness_metrics, by="ID")

# Sample sizes for 
reproductive_values %>% filter(!is.na(Proportional)) %>% count(is.na(lifespan))
reproductive_values %>% filter(!is.na(Proportional)) %>% count(is.na(lrs))
reproductive_values %>% filter(!is.na(Proportional)) %>% count(is.na(lrssa))
reproductive_values %>% filter(!is.na(Proportional)) %>% count(is.na(ngo.kk))
```
