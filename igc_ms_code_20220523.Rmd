...
write.csv(rbind(posterior_summary,r2_summary),"results_table1_20220111.csv")
```
...
# 
r2_summary <- rbind(bayes_R2(m.fit.lifespan.nint_20220111),bayes_R2(m.fit.lrs.nint_20220111),bayes_R2(m.fit.lrssa.nint_20220111),bayes_R2(m.fit.ngo.kk.nint_20220111))
r2_summary <- as.data.frame(round(r2_summary,3))
r2_summary$`95%.CIs` <- paste(r2_summary$Q2.5,r2_summary$Q97.5,sep=" - ")
r2_summary <- r2_summary[,c(1,5)]
r2_summary$`95%.CIs` <- paste(paste("[",r2_summary$`95%.CIs`,sep=""),"]",sep="")

write.csv(rbind(posterior_summary,r2_summary),"results_table1.nint_20220111.csv")
```
...
write.csv(pd[,c(1,2)],"pd_results_table1_20220111.csv")
...
write.csv(pd[,c(1,2)],"pd_zi_results_table1.nint_20220111.csv")
...
```{r}
mcmc_areas(m.fit.lifespan_20220111,pars = parnames(m.fit.lifespan_20220111)[24:53], prob = .95)
mcmc_areas(m.fit.lifespan_20220111,pars = parnames(m.fit.lifespan_20220111)[54:(54+29)], prob = .95)
mcmc_areas(m.fit.lifespan_20220111,pars = parnames(m.fit.lifespan_20220111)[84:(84+29)], prob = .95)
mcmc_areas(m.fit.lifespan_20220111,pars = parnames(m.fit.lifespan_20220111)[114:(114+29)], prob = .95)
# lin 1695
```

```{r}
mcmc_areas(m.fit.lifespan.nint_20220111,pars = parnames(m.fit.lifespan.nint_20220111)[(24-6):(53-6)], prob = .95)
mcmc_areas(m.fit.lifespan.nint_20220111,pars = parnames(m.fit.lifespan.nint_20220111)[(54-6):(54+29-6)], prob = .95)
mcmc_areas(m.fit.lifespan.nint_20220111,pars = parnames(m.fit.lifespan.nint_20220111)[(84-6):(84+29-6)], prob = .95)
mcmc_areas(m.fit.lifespan.nint_20220111,pars = parnames(m.fit.lifespan.nint_20220111)[(114-6):(114+29-6)], prob = .95)
# lin 1695
```
